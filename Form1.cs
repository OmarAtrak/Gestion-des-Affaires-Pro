...
namespace GestionAffaire
{
    public partial class Form1 : Form
    {
        ...
        public void remplirAcceuil()
        {
            ...
            cmd.CommandText = "select cast(convert(money,'" + lblTotalDisposition.Text + "') - convert(money, '" + lblTotalFrais.Text + "') as nvarchar)";
            if (cmd.ExecuteScalar().ToString() != "")
                lblSolde.Text = cmd.ExecuteScalar().ToString();
            else
                lblSolde.Text = "0.00";
        ...
        public Boolean IsEmployeNomExists(string nom, string cin)
        {
            DataTable dt = new DataTable();
            ...
            Boolean isThere = false;
            connecter();
            cmd.CommandText = "select top (1) cin from Personnel where nom='" + nom + "' and cin!='" + cin + "'";
            da.SelectCommand = cmd;
            da.Fill(dt);
            deConnecter();
            if (dt.Rows.Count != 0)
                        ...
                        else
                        {
                            ...
                            if (IsRaisonSocialeClientExists(txtRaisonSocialClient.Text) == false)
                            {
                                ...
                                catch (FormatException ex)
                                {
                                    ...
                                    {
                                        MessageBox.Show("saisir ICE valide", "Erreur", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
                                    }
            ...
            else if (radioButton1.Checked == true)
            {
                if (txtCinPersonne.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        if (txtPrenomPresonne.Text != "" && txtNomPersonne.Text != "")
                        {
                            if (IsEmployeNomExists(txtNomPersonne.Text, txtCinPersonne.Text) == true)
                            {
        ...
        private void btnValiderAff_Click(object sender, EventArgs e)
        {
            ...
            if (cmbNumeroAff.Text != "")
            {
                ...
                {
                    // si le numero d'affaire n'est pas existe dans la base de donnees
        ...
        private void btnModifierAffaire_Click(object sender, EventArgs e)
        {
            ...
            if (cmbNumeroAff.Text != "")
            {
                ...
                {
                    // si l'affaire est deja existe dans la base de donnees
                    if (cmbClientAff.Text != "" && cmbResponsableAff.Text != "")
                    {
                        if (txtNbrJourAffaire.Value.ToString() != null)
                        {
                            if (txtNbrJourAffaire.Value > 0)
                            {
                                try
                                {
                                    ...
                                    //faire le mis a jour vider et remplir les zone de texte
                                    remplirListAffaire();
                                    RemplirNumeroAffaire();
                                }
                                catch (Exception ex)
        ...
        private void btnSupprimerAff_Click(object sender, EventArgs e)
        {
            ...
            if (cmbNumeroAff.Text != "")
            {
                if (IsAffExists(cmbNumeroAff.Text) == true)
                {
                    // si l'affaire n'est pas deja existe dans la base de donnees
                    ...
                    else
                    {
                        if (MessageBox.Show("voulez-vous supprimer cette Affaire?", "Supprimer Affaire", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            try
                            {
                                ...
                                //faire mis a jour vider et remplir les zone de texte
                                cmbNumeroAff.Text = "";
                                RemplirNumeroAffaire();
                                remplirListAffaire();
                                RemplirNomRespo();
        ...
        private void btnPdfAff_Click(object sender, EventArgs e)
        {
            ...
            if (cmbNumeroAff.Text != "")
            {
                ...
                {
                    // si l'affaire est deja existe dans la base donnees

                    //instancer une dataset
                                ...
                                try
                                {
                                    ...
                                    if (radioButton5.Checked == true)
                                    {
                                        if (cmbNumAffaireNote.Text != "")
                                        {
                                            cmd.CommandText = "insert into NoteFrais(Numero,affaire,date,respo) values('" +
                                                                                            ...
                                                                                            cmbNumAffaireNote.Text + "',(select convert(date,'" +
                                                                                            txtDateNote.Text + "',103)),'" +
                                                                                            cmbRespoNote.Text + "')";
                                        }
                                        else
                                        {
                                            cmd.CommandText = "insert into NoteFrais(Numero,date,respo) values('" +
                                                                                            Convert.ToInt32(txtNumeroNote.Text) + "',(select convert(date,'" +
                                                                                            txtDateNote.Text + "',103)),'" +
                                                                                            cmbRespoNote.Text + "')";
                                        }
                                        cmd.ExecuteNonQuery();
                                    ...
                                    for (int i = 0; i < listFraisNote.Rows.Count - 1; i++)
                                    {
                                        ...
                                        cmd.CommandText = "insert into Frais(numero,Type,PiecesComptables,date,frais,noteFrais) values('" +
                                                                                                                ...
                                                                                                                listFraisNote.Rows[i].Cells[2].Value.ToString() + "',(select convert(date,'" +
                                                                                                                listFraisNote.Rows[i].Cells[3].Value.ToString() + "',103)),'" +
            ...
            else
            {
                if (listFraisNote.Rows.Count > 1)
                {
                    try
                    {
                        for (int i = 0; i < listFraisNote.Rows.Count - 1; i++)
                        {
                            if (IsFraisExists(int.Parse(listFraisNote.Rows[i].Cells[0].Value.ToString()), int.Parse(cmbNumeroNote.Text)) == false)
                            {
                                ...
                                cmd.CommandText = "insert into Frais(numero,Type,PiecesComptables,frais,date,noteFrais) values('" +
                                                            ...
                                                            double.Parse(listFraisNote.Rows[i].Cells[4].Value.ToString()).ToString() + "',(select convert(date,'" +
                                                            listFraisNote.Rows[i].Cells[3].Value.ToString() + "',103)),'" +
                        ...
                        // vider et remplire les zone de texte
                        listFraisNote.Rows.Clear();
                        remplirTypeNote();
                        remplirPCNote();
                        NumeroNote();
                        ...
                        remplirBeneficaireNote();
                        txtFraisFrais.Text = "0";
                        txtNumAff.Text = txtTotalFraisNote.Text = txtDateFrais.Text = txtDateNote.Text = "";
        ...
        private void btnSupprimerNoteFrais_Click(object sender, EventArgs e)
        {
            ...
            if (cmbNumeroNote.Text != "")
            {
                ...
                {
                    // si la note de frais est deja existe dans la base de donnees
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            cmbNumeroNote.Text = txtDateFrais.Text = txtDateNote.Text = txtRespoNote.Text = txtNumAff.Text = txtTotalFraisNote.Text = "";
            txtFraisFrais.Text = "0";
                ...
                try
                {
                    ...
                    if (cmbTypeFraisRecheNote.Text != "" && cmbPCFraisRecheNote.Text != "")
                    {
                        cmd.CommandText = "select Numero,Type,PiecesComptables as 'Piece Comptable',Frais,Date,noteFrais as 'Note de Frais' from Frais where Type='"
                                                            ...
                                                            + "' and date between (select convert(date,'"
                                                                + txtDateDebutFraisRecheNote.Text
                                                                + "',103)) and (select convert(date,'"
                                                                + txtDateFinFraisRecheNote.Text
                                                            + "',103)) and frais between '"
                    ...
                    {
                        cmd.CommandText = "select Numero,Type,PiecesComptables as 'Piece Comptable',Frais,Date,noteFrais as 'Note de Frais' from Frais where date between (select convert(date,'"
                                                                + txtDateDebutFraisRecheNote.Text
                                                                + "',103)) and (select convert(date,'"
                                                                + txtDateFinFraisRecheNote.Text
                                                            + "',103)) and frais between '"
                ...
                if (Convert.ToDateTime(txtDateFinMission.Text) >= Convert.ToDateTime(txtDateDebutMission.Text))
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (cmbRespoMission.Text != "" && listeEmployeOrdre.Items.Count == 0)
                            {
                                cmd.CommandText = "insert into Mission(dateDebut,dateFin,lieuDepart,lieuArriver,affaire,respo,nbrPersonne) values((select convert(date,'" +
                                                                                txtDateDebutMission.Text + "',103)),(select convert(date,'" +
                                                                                txtDateFinMission.Text + "',103)),'" +
                            ...
                            {
                                cmd.CommandText = "insert into Mission(dateDebut,dateFin,lieuDepart,lieuArriver,affaire,nbrPersonne) values((select convert(date,'" +
                                                                                txtDateDebutMission.Text + "',103)),(select convert(date,'" +
                                                                                txtDateFinMission.Text + "',103)),'" +
                                                                                txtLieuDepartMission.Text + "','" +
                                                                                txtLieuArriveMission.Text + "','" +
                        ...
                        if (Convert.ToDateTime(txtDateFinMission.Text) >= Convert.ToDateTime(txtDateDebutMission.Text))
                        {
                            try
                            {
                                ...
                                else
                                {
                                    ...
                                    if (cmbRespoMission.Text != "" && listeEmployeOrdre.Items.Count == 0)
                                    {
                                        cmd.CommandText = "update Mission set dateDebut=(select convert(date,'" + txtDateDebutMission.Text +
                                                                "',103)),dateFin =(select convert(date,'" + txtDateFinMission.Text +
                                                                "',103)),lieuDepart='" + txtLieuDepartMission.Text +
                ...
                if (DateTime.Parse(txtDateFinMissionReche.Value.ToString()) >= DateTime.Parse(txtDateDebutMissionReche.Value.ToString()))
                {
                    if (cmbAffMissionReche.Text != "" && cmbRespoMissionReche.Text != "" && txtLieuDepartMissionReche.Text != "" && txtLieuArriverMissionReche.Text != "")
                    {
                        cmd.CommandText = "select numero as 'Numero', respo as 'Chargé d''affaire',dateDebut as 'Date Debut',dateFin as 'Date Fin',NbrJour as 'Nombre de Jours',lieuDepart as 'Lieu Départ',lieuArriver as 'Lieu Arrivé',nbrPersonne as 'Number de Personne',affaire as 'Affaire' from Mission where respo='"
                                                            ...
                                                            + "' and (dateDebut >= (select convert(date,'"
                                                                + txtDateDebutMissionReche.Text
                                                            + "',103)) and dateFin<=(select convert(date,'"
                                                                + txtDateFinMissionReche.Text
                                                            + "',103)))";
                    }
        ...
        private void label58_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "select * from Banque";
                da.SelectCommand = cmd;
                da.Fill(ds, "Banque");
                ...
                cmd.CommandText = "select * from DetailMission";
                da.SelectCommand = cmd;
                da.Fill(ds, "DetailMission");
                ...
                cmd.CommandText = "select * from MiseDisposition";
                da.SelectCommand = cmd;
                da.Fill(ds, "MiseDisposition");
                ...
                cmd.CommandText = "select * from NoteFrais";
                da.SelectCommand = cmd;
                da.Fill(ds, "NoteFrais");
